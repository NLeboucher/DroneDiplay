...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    button.addEventListener('click', showIPValue());
});
...
function showIPValue() {
    ...
    const useTrueDrones = asyncCall(IP) === "API Connected";
    if(useTrueDrones){
        document.getElementById('button1').value = "API Connected";
    }
    else{
        document.getElementById('button1').value = "API Not Connected";
    }
